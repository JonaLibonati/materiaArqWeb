...
//Array of proyects
const projectNames = ['penJujuy', 'comRivPark', 'olympicVill', 'plaFerCab', 'ambientalSur', 'losReartesBoul', 'footballMuseum', 'luroTerminal', 'lacarCoast', 'centenPav', 'uccPolo', 'jockeyClub', 'acindar', 'ferrocult', 'chanarPark', 'berazcomplex', 'parqPatri', 'educBuild', 'vlHouse', 'svHouse', 'prsBuild', 'ldBuild', 'alsina', 'brdBuild', 'estEco', 'plaColeg', 'argPav', 'salgCoast', 'marqPav'];
